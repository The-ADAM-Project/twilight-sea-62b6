...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/twilight-sea-62b6)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/twilight-sea-62b6
```

A live public deployment of this template is available at [https://twilight-sea-62b6.templates.workers.dev](https://twilight-sea-62b6.templates.workers.dev)
